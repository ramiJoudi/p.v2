$(document).ready(function () {
    ...
    $("#holder").writeText("FULL-STACK DEVELOPER  + DEVOPS JAVA");
    ...
    $("#fullpage").fullpage({
      ...
      responsiveWidth: 400,
      navigation: true,
      navigationTooltips: ["home", "about","skill", "portfolio", "contact", "connect"],
      anchors: ["home", "about","skill", "portfolio", "contact", "connect"],
      menu: "#myMenu",
      fitToSection: false,
